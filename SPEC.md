...
> **Note (2026-07-17):** the hierarchical-workflow formalism specified in
> §2.3–§2.4, §3–§6, §8, §10.1–§10.4, and §12 is implemented by `@ai-exec/hw` in
> the shared ai-exec repo; the canonical copy of those sections for the engine
> lives at `C:\UbuntuCode\ai-exec\SPEC.md`. This file remains the product
> specification for the JaiRA app (tasks, boards, safety policy, Git isolation).
