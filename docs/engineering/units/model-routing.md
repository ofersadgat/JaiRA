...
- Callers: CLI `buildRunEnvironment`; app `promptWiring`, `defaultTree`, `computeAvailability`, `probeModelRoutes` behind IPC `model:probe`, and `knownModels` for the composer.
