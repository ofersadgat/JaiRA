 ...
 * resolved inputs into one namespace. That merge is why {@link ComponentConfig} fields must tolerate
 * finding a VALUE where they expected a name — see `user-approve-changeset.changeset`, the one field
 * that names another input and therefore collides with it.
 *
