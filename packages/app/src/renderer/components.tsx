...
// The per-command approval (DESIGN 10.2, decision 0007 section 4) lives in its own file; it is
// re-exported here because this module is where every other gate surface is imported from.
export { ApprovalDialog, ApprovalSurface, type ApprovalAnswerExtras, type ApprovalSurfaceProps } from "./approvalSurface";
