...
export function componentsWorkflowFiles(): Record<string, unknown> {
  ...
  return {
    components: {
      ...
      inputs: { doc: artifact },
      outputs: {
        decision: { schema: { type: "string" }, binding: ".children.choose.output.decision" },
        review: { schema: { type: "string" }, binding: ".children.review.output.decision" },
        edited: { ...artifact, binding: ".children.edit.output.content" },
        severity: { schema: { type: "string" }, binding: ".children.form.output.severity" },
        confirmed: { schema: { type: "boolean" }, binding: ".children.confirm.output.confirmed" },
      },
      children: {
        choose: { state: "components/choose" },
        review: {
          state: "components/review",
          inputs: { plan_doc: ".inputs.doc", previous: ".children.choose.output.decision" },
        },
        edit: {
          state: "components/edit",
          inputs: { plan_doc: ".inputs.doc", previous: ".children.review.output.decision" },
        },
        form: { state: "components/form", inputs: { previous: ".children.edit.output.content" } },
        confirm: { state: "components/confirm", inputs: { previous: ".children.form.output.severity" } },
      },
